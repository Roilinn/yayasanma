<nav x-data="{ open: false }" class="border-b border-gray-100 bg-white dark:border-gray-700 dark:bg-gray-800">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="space-y-1 pb-3 pt-2">
            ...
            <!-- Tambah navigasi responsif ke rute anak -->
            <x-responsive-nav-link :href="route('anak.index')" :active="request()->routeIs('anak.*')">
                {{ __('Anak') }}
            </x-responsive-nav-link>

            <!-- Tambah navigasi responsif ke rute pengurus -->
            <x-responsive-nav-link :href="route('pengurus.index')" :active="request()->routeIs('pengurus.*')">
                {{ __('Pengurus') }}
            </x-responsive-nav-link>

            <!-- Tambah navigasi responsif ke rute galeri -->
            <x-responsive-nav-link :href="route('galeri.index')" :active="request()->routeIs('galeri.*')">
                {{ __('Galeri') }}
            </x-responsive-nav-link>

            <!-- Tambah navigasi responsif ke rute berita -->
            <x-responsive-nav-link :href="route('berita.index')" :active="request()->routeIs('berita.*')">
                {{ __('Berita') }}
            </x-responsive-nav-link>

            <x-responsive-nav-link :href="route('pesan.index')" :active="request()->routeIs('pesan.*')">
                {{ __('Pesan') }}
            </x-responsive-nav-link>
        </div>
